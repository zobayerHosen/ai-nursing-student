...
export default function DiagnosticTestClient() {
        ...
        <div className="bg-white rounded-2xl p-10 border border-[#EEEEEE] shadow-sm text-center">
          <div className="max-w-md mx-auto">
            <h2 className="text-2xl font-bold text-[#111827] mb-3">
              Diagnostic Lab Not Found
            </h2>
            <p className="text-[#7A7A7A] mb-6">
              The diagnostic test or lab you are looking for does not exist or has been moved.
            </p>
            <Link
  ...
  return (
    <div className="w-full flex flex-col">
      {/* Top Buttons */}
      <DashboardBreadcrumb
        backHref="/dashboard/diagnostic-test-labs"
        backLabel="Diagnostic Tests & Labs"
        currentLabel={currentCategory?.title || currentNote?.content_name}
          ...
          {currentNote?.content_file_url ? (
            <>
              ...
              <iframe
                ...
                title={currentNote.content_name || "Diagnostic Lab Content"}
