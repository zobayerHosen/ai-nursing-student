      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3 self-start md:self-auto">
          ...
          <button 
            ...
            className={`px-4 py-2.5 rounded-lg flex items-center gap-2 text-sm font-semibold transition-all duration-350 cursor-pointer shadow-sm ${
              isCompleted 
                ? 'bg-[#10B981] hover:bg-[#059669] text-white' 
                : 'bg-[#FF6B8A] hover:bg-[#E05270] text-white'
            }`}
          >
