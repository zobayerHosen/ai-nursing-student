...
export default function FlashcardsSidebar({
  ...
  return (
    <aside className="w-full lg:w-[330px] xl:w-[360px] shrink-0 border-r border-[#E5E7EB] bg-white px-4 py-5 sm:px-6 lg:min-h-[calc(100vh-82px)]">
      <div className="mx-auto flex max-w-md flex-col gap-4 lg:max-w-none">
        <div>
          <h1 className="text-lg font-semibold text-[#222427]">Flashcards</h1>
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-[10px] font-medium text-[#697586]">Maximum 30 cards</p>
        </div>
