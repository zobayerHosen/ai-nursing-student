...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-rose-500 selection:text-white">
      ...
      <Header
        ...
        onExport={() => {
          // Trigger PDF export via share modal - click the PDF button
