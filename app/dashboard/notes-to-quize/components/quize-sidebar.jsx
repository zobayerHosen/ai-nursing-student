    ...
    <aside className="w-full shrink-0 border-r border-[#E5E7EB] bg-white lg:min-h-[calc(100vh-82px)] lg:w-[330px] xl:w-[360px]">
      ...
      <div className="flex border-b border-[#E5E7EB]">
        <button
          ...
          className={`flex flex-1 items-center justify-center gap-2 px-4 py-3 text-xs font-semibold transition ${
            activeTab === "tool"
              ? "border-b-2 border-[#2C5F8D] text-[#2C5F8D]"
      ...
      {activeTab === "tool" ? (
        ...
        <div className="px-4 py-5 sm:px-6">
          ...
          {quizzes.length === 0 ? (
            <p className="text-[11px] text-[#697586]">No quiz history yet.</p>
          ) : (
            <div className="space-y-2">
