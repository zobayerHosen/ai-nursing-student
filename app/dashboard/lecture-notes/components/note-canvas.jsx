    ...
    <>
      ...
      <div className="w-full bg-white border border-gray-200/70 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.02)] h-[calc(100vh-250px)] min-h-[400px] max-h-[calc(100vh-200px)] p-8 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 w-full text-sm text-[#333E49] leading-relaxed font-normal min-h-0 overflow-hidden
          ...
          [&_.tiptap]:pr-2
          [&_.tiptap]:scrollbar-thin
          [&_.tiptap]:scrollbar-thumb-gray-300
          [&_.tiptap]:scrollbar-track-transparent
          [&_.tiptap_p]:mb-3 
          [&_.tiptap_p]:min-h-[1rem]
          [&_.tiptap_p]:break-words
          [&_.tiptap_p]:whitespace-pre-wrap
          ...
          [&_.tiptap_h1]:mb-3 
          [&_.tiptap_h1]:mt-4
          [&_.tiptap_h1]:break-words
          [&_.tiptap_h1]:whitespace-pre-wrap
          [&_.tiptap_h2]:text-2xl 
          [&_.tiptap_h2]:font-bold 
          [&_.tiptap_h2]:text-[#333E49] 
          [&_.tiptap_h2]:mb-2 
          [&_.tiptap_h2]:mt-3
          [&_.tiptap_h2]:break-words
          [&_.tiptap_h2]:whitespace-pre-wrap
          [&_.tiptap_h3]:text-xl  
          [&_.tiptap_h3]:font-bold 
          [&_.tiptap_h3]:text-[#333E49] 
          [&_.tiptap_h3]:mb-2 
          [&_.tiptap_h3]:mt-2
          [&_.tiptap_h3]:break-words
          [&_.tiptap_h3]:whitespace-pre-wrap
          [&_.tiptap_ul]:list-disc 
          [&_.tiptap_ul]:pl-5 
          [&_.tiptap_ul]:mb-3
          [&_.tiptap_ul]:break-words
          [&_.tiptap_ul]:whitespace-pre-wrap
          [&_.tiptap_ol]:list-decimal 
          [&_.tiptap_ol]:pl-5 
          [&_.tiptap_ol]:mb-3
          [&_.tiptap_ol]:break-words
          [&_.tiptap_ol]:whitespace-pre-wrap
          ...
          [&_.tiptap_blockquote]:break-words
          [&_.tiptap_blockquote]:whitespace-pre-wrap
          [&_.tiptap_highlight]:rounded-sm 
          [&_.tiptap_highlight]:px-0.5
          [&_.tiptap]:focus-within:outline-none
        ">
          <EditorContent editor={editor} className="h-full w-full tiptap-editor-content" />
        </div>
